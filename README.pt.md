...
<p align="center">
  <a href="https://github.com/mad4tv/romcase/releases/latest/download/ROM-Case-1.7.dmg">
    <img src="https://img.shields.io/badge/Descarregar-ROM%20Case%201.7.dmg-4FB8FF?style=for-the-badge&logo=apple&logoColor=white" alt="Descarregar ROM Case 1.7.dmg">
  </a>
  &nbsp;
...
**[ROM-Case-1.7.dmg](https://github.com/mad4tv/romcase/releases/latest/download/ROM-Case-1.7.dmg)** — arrasta **ROM Case** para Aplicações.
...
1. [Descarrega o `ROM-Case-1.7.dmg`](https://github.com/mad4tv/romcase/releases/latest/download/ROM-Case-1.7.dmg)
2. Se o macOS mostrar **«A Apple não conseguiu confirmar…»** / **Mover para o Lixo**, é o Gatekeeper. **Não** móvas para o Lixo. Clica **OK** e depois:
   ...
   - Desce até à mensagem sobre o `ROM-Case-1.7.dmg`
